...
html_en:
	...
	$(ASCIIDOCTOR) -a source-highlighter=coderay -a stylesdir=styles -a target-version=1.10 -d book -b html5 en/index.adoc -D$(BUILDDIR)/html/en/
...
html_ja:
	...
	$(ASCIIDOCTOR) -a source-highlighter=coderay -a target-version=1.10 -d book -b html5 ja/index_ja.adoc -D$(BUILDDIR)/html/ja
