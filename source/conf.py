...
extensions = ['sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.ifconfig']
...
project = u'RedPen'
copyright = u'2015, Recruit Technologies Co., Ltd'
