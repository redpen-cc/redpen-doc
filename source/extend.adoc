...
JavaScriptValidator will load all files with .js suffix from `$REDPEN_HOME/js` directory. This location can be overriden with `script-path` property of JavaScriptValidator.
...
　　<validators>
       ...snip...
　　　　<validator name="JavaScript" >
　　　　　　<property name="script-path" value="/path/to/your/validator/directory" />
    　</validator>
　　</validators>
</redpen-conf>
----
